...
class ProfileTestClass(TestCase):
    def setUp(self):
        self.new_user=User(id=1,username='Phoebe')
        self.new_profile=Profile(id=2,bio='lionne',profile_pic='default.jpg',full_name='PhoebeNjeri', user=self.new_user, email='Phoebegichuhi4@gmail.com', phone_number='0707825891')
